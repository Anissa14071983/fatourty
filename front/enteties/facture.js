export class Facture {
    ...
    fields = [ "totalfacture", "datefacture", "client_id_client", "etatfacture" ]

		labels = [ "Total facture", "Date facture", "client_id_client", "etatfacture" ]

	  columns =[ "totalfacture","etatfacture",'Actions']
